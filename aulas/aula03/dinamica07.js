...
class Pesquisador extends Professor {
    ...
    toJSON() {
        return {
            nome: this.nome,
            cargaHorariaMensal: super.cargaHorariaMensal,
            cargaHorariaPesquisa: this.cargaHorariaPesquisa,
            cargaHorariaTotal: this.cargaHorariaMensal,
            salarioBase: this.salarioBase,
            salarioLiquido: this.salarioLiquido.toFixed(2),
        };
    }
...
console.log(JSON.stringify(pesq, null, 2));
